...
import { MatTableDataSource, MatDialogConfig, MatDialog, MatSnackBar , Sort } from '@angular/material';
...
@Component({
  selector: 'app-drawing-table-reduced',
  templateUrl: './drawing-table-reduced.component.html',
  styleUrls: ['./drawing-table-reduced.component.css']
})
export class DrawingTableReducedComponent implements OnInit {
