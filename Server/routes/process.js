...
const { Drawing, Operation, PlanAbstract, Process, Instrument, MeasuringFrequency, dimension } = require('./../models')
...
router.get('/ctq/:drgCode/:opnId', (req, res) =>  {
    return new Promise((resolve, reject) => {
        Process.findAll({ where: { drgCode: req.params.drgCode, opnId: req.params.opnId } }).then(function (result) {
            sendSuccess(res, result);
        }).catch(function (err) {
...
router.get('/firstPartInspection/:drgCode/:opnId', (req, res) =>  {
    return new Promise((resolve, reject) => {
...
router.get('/periodicInspection/:drgCode/:opnId', (req, res) =>  {
    return new Promise((resolve, reject) => {
        Process.findAll({ where: { drgId: req.params.drgCode, opnId : req.params.opnId, deleteStatus : false },include: [Instrument] }).then(function (result) {
            sendSuccess(res, result);
        }).catch(function (err) {
